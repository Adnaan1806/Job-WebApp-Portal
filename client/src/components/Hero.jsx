...
const Hero = () => {
  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10">
      <div className="bg-gradient-to-r from-pink-800 to-purple-900 text-white py-16 text-center mx-2 rounded-xl">
        ...
        <div className="flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto">
          ...
          <button
            onClick={onSearch}
            className="bg-pink-600 px-6 py-2 rounded text-white m-1 cursor-pointer hover:bg-pink-500 transition-all duration-300"
          >
            Search
          </button>
        </div>
      ...
      <div className="border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex">
        <div className="flex justify-center gap-2 lg:gap-20 flex-wrap">
