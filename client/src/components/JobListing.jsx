...
const JobListing = () => {
  ...
  useEffect(() => {
    ...
    const matchesTitle = job => searchFiler.title === "" || job.title.toLowerCase().includes(searchFiler.title.toLowerCase());

    const matchesSearchLocation = job => searchFiler.location === "" || job.location.toLowerCase().includes(searchFiler.location.toLowerCase());
  ...
  }, [jobs, selectedCategories, selectedLocations, searchFiler]);
